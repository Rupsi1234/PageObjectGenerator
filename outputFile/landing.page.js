...
landing_img:(action.getElementCount(this.landing_img) > 0) ? action.waitForDisplayed(this.landing_img) : false,
}
 return obj; 
},
...
var obj;
obj = {
brandLogo_img:(action.getElementCount(this.brandLogo_img) > 0) ? action.waitForDisplayed(this.brandLogo_img) : false,
selectedLangImg:(action.getElementCount(this.selectedLangImg) > 0) ? action.waitForDisplayed(this.selectedLangImg) : false,
...
footerImg:(action.getElementCount(this.footerImg) > 0) ? action.waitForDisplayed(this.footerImg) : false,
}
 return obj; 
},
